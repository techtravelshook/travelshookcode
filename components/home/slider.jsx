...
export default function TravelSlider() {
  ...
  const [hoveredBtn, setHoveredBtn] = useState(null); // 'prev' | 'next' | null
  ...
  // ── Style 6: Gradient rounded square button styles ──
  const arrowBtnBase = {
    position: 'absolute',
    top: '50%',
  ...
  return (
    <div
      ...
      style={{
        paddingBottom: isMobile ? '140%' : '45.458%',
        height: 0,
      }}
