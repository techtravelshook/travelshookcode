...
//   // // England
//   // { code: "MAN", label: "Manchester (MAN)", flag: "🇬🇧" },
//   // { code: "BHX", label: "Birmingham (BHX)", flag: "🇬🇧" },
//   // { code: "LPL", label: "Liverpool (LPL)", flag: "🇬🇧" },
//   // { code: "NCL", label: "Newcastle (NCL)", flag: "🇬🇧" },
//   // { code: "BRS", label: "Bristol (BRS)", flag: "🇬🇧" },
//   // { code: "LBA", label: "Leeds Bradford (LBA)", flag: "🇬🇧" },
//   // { code: "EMA", label: "East Midlands (EMA)", flag: "🇬🇧" },

//   // // Scotland
//   // { code: "EDI", label: "Edinburgh (EDI)", flag: "🏴" },
//   // { code: "GLA", label: "Glasgow (GLA)", flag: "🏴" },
//   // { code: "ABZ", label: "Aberdeen (ABZ)", flag: "🏴" },
//   // { code: "INV", label: "Inverness (INV)", flag: "🏴" },

//   // // Wales
//   // { code: "CWL", label: "Cardiff (CWL)", flag: "🏴" },

//   // // Northern Ireland
//   // { code: "BFS", label: "Belfast International (BFS)", flag: "🇬🇧" },
//   // { code: "BHD", label: "Belfast City (BHD)", flag: "🇬🇧" },
// ];
...
//   // { code: "MUX", label: "Multan (MUX)", flag: "🇵🇰" },
//   // { code: "PEW", label: "Peshawar (PEW)", flag: "🇵🇰" },
//   // { code: "SKT", label: "Sialkot (SKT)", flag: "🇵🇰" },
//   // { code: "UET", label: "Quetta (UET)", flag: "🇵🇰" },
//   // { code: "LYP", label: "Faisalabad (LYP)", flag: "🇵🇰" },
...
//                     {/* From */}
//                     <div className="flex-1 min-w-[140px]">
//                       <label className="block text-xs font-semibold text-orange-600 dark:text-orange-400 mb-1">FROM</label>
//                       <div className="relative">
//                         <input
//                           type="text"
//                           value={fromAirport?.label || leg.from}
//                           onChange={(e) => {
//                             const match = ALL_AIRPORTS.find(a => 
//                               a.label.toLowerCase().includes(e.target.value.toLowerCase()) ||
//                               a.code.toLowerCase() === e.target.value.toLowerCase()
//                             );
//                             if (match) updateLeg(idx, "from", match.code);
//                           }}
//                           placeholder="From"
//                           className="w-full h-9 px-3 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-300 dark:focus:ring-orange-600 transition-all"
//                         />
//                         {fromAirport && (
...
//                     {/* To */}
//                     <div className="flex-1 min-w-[140px]">
//                       <label className="block text-xs font-semibold text-orange-600 dark:text-orange-400 mb-1">TO</label>
//                       <div className="relative">
//                         <input
//                           type="text"
//                           value={toAirport?.label || leg.to}
//                           onChange={(e) => {
//                             const match = ALL_AIRPORTS.find(a => 
//                               a.label.toLowerCase().includes(e.target.value.toLowerCase()) ||
//                               a.code.toLowerCase() === e.target.value.toLowerCase()
//                             );
//                             if (match) updateLeg(idx, "to", match.code);
//                           }}
//                           placeholder="To"
//                           className="w-full h-9 px-3 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-xs focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-300 dark:focus:ring-orange-600 transition-all"
//                         />
...
//                         className="h-9 w-9 rounded-lg bg-red-100 dark:bg-red-900/30 border border-red-300 dark:border-red-700 flex items-center justify-center hover:bg-red-200 dark:hover:bg-red-900/50 transition-all text-red-600 dark:text-red-400 hover:scale-110 transform duration-200"
//                         title="Remove leg"
//                       >
//                         <Trash2 size={16} />
//                       </button>
...
//               {/* Bottom Row: Travelers, WhatsApp, Search */}
