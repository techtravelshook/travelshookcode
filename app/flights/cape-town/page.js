...
import InquiryModel from '@/components/flightservice/flightsplaces/InquiryModel';
...
function CapeTown() {
  ...
  <BookNowPayLaterBanner 
      ...
      {/* 4. Render the popup layer cleanly at the root block level of your page output stack */}
      <InquiryModel 
        destination="Cape Town"
        isOpen={isModalOpen}
